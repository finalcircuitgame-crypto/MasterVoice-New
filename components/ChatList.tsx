...
export const ChatList: React.FC<ChatListProps> = ({ currentUser, onSelectUser }) => {
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {users.map((user) => (
          <button
            ...
            className="w-full p-4 flex items-center space-x-3 hover:bg-gray-700 transition border-b border-gray-700/50 text-left"
          >
